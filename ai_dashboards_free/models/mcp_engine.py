...
from odoo.addons.ai_mcp_free.models.mcp_url import public_base_url
...
class MCPEngine(models.AbstractModel):
    ...
    def _dashboard_url(self, dashboard):
        ...
        return "%s/odoo/action-ai_dashboards_free.action_dashboards/%s" % (
            base, dashboard.id)
...
class MCPTool(models.Model):
    ...
    def _write_handlers(self):
        ...
        were never granted odoo:write. ai_mcp_free's
